...
\dfn{Uniform Continuity}{
    A function $f \colon X \to Y$ from the metrix space $(X, d_X)$
...
\mlemma[lebesgueN]{The Lebesgue Number Lemma}{
    ...
    \[
        \exs \delta \in \RR_+,\: \forall B \in \mcal P(X) \setminus \{\varnothing\},\:
...
\pf{Proof}{
    ...
    \Cref{th:cldInCptIsCpt}. Furthermore, $\cl V \cap W = \varnothing$;
