...
\thm[BW]{Bolzano–Weierstra Theorem}{
...
\dfn{Bolzano–Weierstra Property}{
	We say that a nonempty set $X$ has the \textit{Bolzano–Weierstra property}
...
\begin{itemize}[nolistsep]
	\ii $k_0 \coloneqq 0$
	\ii For each $j \in \NN$, $k_j \in \{\, k \in \NN \mid k > k_{j-1} \text{ and } x_k \in N(c; \veps) \,\}$.
\end{itemize}
Since $c$ is a cluster point, $\{\, k \in \NN \mid k > k_{j-1} \text{ and } x_k \in N(c; \veps) \,\} \neq \varnothing$
