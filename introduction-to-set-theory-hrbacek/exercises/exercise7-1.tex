...
\pf{Proof}{
    This is a special case of \Cref{exer:7.2.4}.
}
...
\exer[7.1.6]{}{
    ...
    \begin{enumerate}[nolistsep, label=(\roman*), ref=\protect{\Cref{exer:7.1.6} (\roman*)}]
        ...
        \ii \(h(A) \le h^\ast(A)\).
        \ii\label{itm:7.1.6.v}
        If \(A\) is well-orderable, then \(h(A) = h^\ast(A)\).
    \end{enumerate}
}
\mclm{Proof}{\hfill
