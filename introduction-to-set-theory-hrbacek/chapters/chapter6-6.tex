...
\mlemma[ordinalQuotientLog]{}{
    ...
    \begin{enumerate}[nolistsep, label=(\roman*), ref=\protect{\Cref{lem:ordinalQuotientLog} (\roman*)}]
        ...
        If \(0 < \alpha \le \beta\), then \(\{\,\xi \mid \xi~\text{is an ordinal and}~\alpha \cdot \xi \le \beta\,\}\)
        has a greatest element.
        \ii\label{itm:ordinalLog}
        If \(1 < \alpha \le \beta\), then \(\{\,\xi \mid \xi~\text{is an ordinal and}~\alpha^\xi \le \beta\,\}\)
        has a greatest element.
    \end{enumerate}
}
\mclm{Proof}{\hfill
\begin{enumerate}[nolistsep, label=(\roman*), leftmargin=*, listparindent=\parindent]
    ...
    exists by \ref{itm:basicOrdinal.iv}.
    ...
    and \(\gamma = \max \{\,\xi \mid \xi~\text{is an ordinal and}~\alpha \cdot \xi \le \beta\,\}\).
...
\pf{Proof}{
    \(\gamma \triangleq \max \{\,\xi \mid \xi~\text{is an ordinal and}~\alpha \cdot \xi \le \beta\,\}\)
...
\pf{Proof}{
    ...
    By \ref{itm:ordinalLog}, there exists \(\beta_1 \triangleq \max \{\,\xi \mid \omega^\xi \le \alpha\,\}\).
