...
\pf{Proof}{
    ...
    \clm[FMsBqJPY]{
        ...
        \(\left(|A|, \restr{\mathord{\le}}{|A|^2}\right)\)
        and \(\big(A, \restr{\mathord{\preceq}}{A^2}\big)\).
    }{
        We have existence for each \(A\) by \Cref{th:??}. % TODO: fill this
        ...
        \(\left(n+1, \restr{\mathord{\le}}{(n + 1)^2}\right)\)
        and \(\big(A, \restr{\mathord{\preceq}}{A^2}\big)\).
        ...
        \(\left(n, \restr{\mathord{\le}}{n^2}\right)\)
        and \(\big(B, \restr{\mathord{\preceq}}{B^2}\big)\).
